        ...
        <div class="row">
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="blog-left-section">
                    ...
                    <div class="side-web side-bar-responsive blog-left-categories blog-common-wide wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                        <h5>Categories</h5>
                        <ul class="list">
                    ...
                    <div class="side-web side-bar-responsive blog-left-deal blog-common-wide wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                        <h5>Best Seller</h5>
                    ...
                    <div class="row" id="products">
                        ...
                        @foreach ($products as $product)
                            @if ($i == 1)
                                <div class="row">
                            @endif
                                <div class="col-md-4 col-sm-4 col-xs-12 wow fadeInDown shop-main-list-responsive" data-wow-duration="1000ms" data-wow-delay="300ms">
                                    <div class="shop-main-list">
                                        ...
                                        <a href="{{ route('detail', $product->slug) }}"><h5>
                                            @php    
